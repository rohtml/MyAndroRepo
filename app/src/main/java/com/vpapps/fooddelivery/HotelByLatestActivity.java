...
/*
        if (!type.equals(getString(R.string.hotel_list))) {
            ...
            adapterHotelList = new AdapterHotelList(HotelByLatestActivity.this, arrayList_hotel, new ClickListener() {
                @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_cart_search:
                Intent intent = new Intent(HotelByLatestActivity.this, CartActivity1.class);
                startActivity(intent);
                break;
        }
